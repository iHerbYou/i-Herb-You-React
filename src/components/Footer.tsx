        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              <a href="#" className="block text-brand-gray-300 hover:text-white">회사소개</a>
              <a href="#" className="block text-brand-gray-300 hover:text-white">이용약관</a>
              <a href="#" className="block text-brand-gray-300 hover:text-white">개인정보처리방침</a>
              <a href="#" className="block text-brand-gray-300 hover:text-white">이용안내</a>
            </div>
          </div>
